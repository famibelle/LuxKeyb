...
$storePwd = "REDACTED_PASSWORD"
$keyPwd = "REDACTED_PASSWORD"
...
Write-Host "  Mot de passe: REDACTED_PASSWORD"
Write-Host ""
...
try {
    ...
    if ($process.ExitCode -eq 0) {
        ...
        Write-Host "Mot de passe: REDACTED_PASSWORD" -ForegroundColor Cyan
        Write-Host ""
